    ...
    try:
        ...
        with zipfile.ZipFile(io.BytesIO(resp.read())) as z:
            for logname in z.namelist():
                ...
                gpt4o_full = len(re.findall(r'gpt-4o\b', content, re.I))
                gpt4o_mini = len(re.findall(r'gpt-4o-mini', content, re.I))
                gpt41_mini = len(re.findall(r'gpt-4.1-mini', content, re.I))
                ...
                if gpt4o_full > 0: models_used.add('GPT-4o (GitHub/OpenAI)')
                if gpt4o_mini > 0: models_used.add('GPT-4o-mini (GitHub/OpenAI)')
                if gpt41_mini > 0: models_used.add('GPT-4.1-mini (GitHub/OpenAI)')
