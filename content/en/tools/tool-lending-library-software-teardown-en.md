...
The [LA County Library's Tool Lending Library](https://library.lacounty.gov/tools/) circulates over 1,060 tools, but every single one of those items is a potential liability vector. The operational cost includes not just maintenance, but legal risk mitigation. This is a burden that commercial rental agencies like Home Depot build into their pricing models, but non-profits often underestimate.
...
The [Riverside Tool Lending Library](https://www.riversideca.gov/library/library-services/riverside-tool-lending-library) offers tools for home and car repairs, but the liability exposure for automotive work is higher due to the complexity and torque involved. Managing this risk requires constant vigilance and often results in conservative lending policies that frustrate power users.
