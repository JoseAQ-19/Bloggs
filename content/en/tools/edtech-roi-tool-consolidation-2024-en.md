...
image: /images/edtech-roi-tool-consolidation-2024-en.jpg
language: en
...
Vendor lock-in has created a "trap" where districts cannot easily audit where their data lives or who has access to it. When a district uses 2,982 tools annually, tracking data flow becomes an exercise in futility, with data often residing in jurisdictions that violate state or federal privacy laws. The [NCES report on education technology](https://nces.ed.gov/pubs2021/2021017Summary.pdf) outlines the scope of technology usage, but the security implications of this sprawl are terrifying. Each unused app is a potential open door for hackers, a dormant account waiting to be compromised in a credential stuffing attack. Consolidation is a defensive maneuver to reduce the number of targets.
