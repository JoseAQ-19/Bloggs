...
Performance data will be available once the fund has been operational for a period, typically within one quarter of its launch.
  ...
  "mainEntityOfPage": "True"
...

    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "While THOR targets a 5% yield, competitors like VYM and DVY have delivered higher returns in the short term."
      }
    },
    {
      "@type": "Question",
      "name": "What types of securities does the THOR ETF invest in?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The THOR ETF aims to invest in a diversified range of income-generating assets, including equities and fixed income."
      }
    },
    {
      "@type": "Question",
      "name": "What are the risks associated with investing in the THOR ETF?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Risks include interest rate fluctuations, economic downturns, and reliance on the performance of selected securities."
      }
    },
    {
      "@type": "Question",
      "name": "When will the THOR ETF start providing historical performance data?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Performance data will be available once the fund has been operational for a period, typically within one quarter of its launch."
      }
    }
  ]
}
