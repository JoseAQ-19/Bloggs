...
The [FTC](https://www.ftc.gov/) requires disclosure whenever a material relationship exists between a creator and a brand. The form of compensation does not matter. AI cannot guarantee that influencers will comply with these guidelines. Brands must still take responsibility for ensuring transparency and ethical behavior in their influencer campaigns. The FTC has made clear that it will enforce these rules.
