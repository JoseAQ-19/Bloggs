...
En el plano on-chain, la caída se refleja en la reducción del interés institucional. El Total Value Locked (TVL) en exchanges centralizados cayó un 2.0% en las últimas 24 horas, con Binance CEX liderando con $149.07 mil millones según datos de [DefiLlama](https://defillama.com). Aunque esta caída es moderada en el contexto del mercado global, señala una desconfianza creciente entre los grandes tenedores. El número de holders únicos de Bitcoin se mantiene estable en 54.2 millones, pero la concentración en wallets institucionales de 10,000 BTC o más aumentó un 0.8% en el último mes, indicando que los movimientos de ballenas dominan el mercado.
