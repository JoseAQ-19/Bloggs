...
Estudios recientes demuestran, , que el oro ejerce una "dominancia causal" sobre Bitcoin, especialmente en periodos de estrés de mercado. El oro es el líder, Bitcoin el seguidor. La supuesta "propiedad de oro digital" de Bitcoin es una quimera, una ilusión que solo se manifiesta en condiciones muy específicas y a largo plazo. En condiciones normales, la relación entre ambos activos es prácticamente inexistente. Un análisis en *Nature* **disponible aquí** explora en detalle estas dinámicas.
