...
**El dato.** Un estudio publicado en [PubMed](https://pubmed.ncbi.nlm.nih.gov/36457356/) sobre la posición del eje en la silla de ruedas y su efecto en el rendimiento de propulsión demuestra que pequeños cambios en la configuración geométrica tienen impactos masivos en la estabilidad y la eficiencia.
...
**Contexto.** La investigación sobre el control de sillas de ruedas "Ballbot" con control del torso, disponible en el repositorio de la [NSF](https://par.nsf.gov/biblio/10548365-driving-ballbot-wheelchair-hands-free-torso-control), explora nuevas formas de control que requieren sistemas de estabilización activa inexistentes en las sillas comerciales actuales.

Los avances en investigación, como los mencionados en los informes de la [NSF](https://par.nsf.gov/servlets/purl/10548365), apuntan hacia futuros donde el control de la silla requiere sistemas de asistencia activa para mantener la estabilidad. Las sillas actuales, modificadas para ir más rápido, carecen por completo de estos sistemas de seguridad activa (como el control de tracción o la estabilización electrónica). El usuario depende totalmente de su habilidad física para compensar las inercias, lo cual es una ilusión peligrosa. En una frenada de emergencia o una maniobra evasiva, una silla modificada no responderá de manera lineal; las ruedas pueden bloquearse, el chasis puede deformarse y el usuario será proyectado fuera del sistema de sujeción. La tecnología de las sillas comerciales está décadas por detrás de la potencia que los usuarios intentan extraer de ellas mediante modificaciones.
...
- [pubmed.ncbi.nlm.nih.gov](https://pubmed.ncbi.nlm.nih.gov/36457356/)
