...
Esta migración de riesgos desde los balances públicos a estas estructuras privadas es una bomba de tiempo. Los reguladores han fallado miserablemente en controlar este sector, permitiendo que el apalancamiento se acumule en derivados y vehículos financieros opacos. La opacidad no es un error, es una característica del sistema.
...
Las consecuencias de esta crisis ya se están manifestando. El aumento del desempleo, la caída de los ingresos disponibles y los recortes en los servicios públicos son solo el principio. La clase media está siendo exprimida hasta la extenuación, mientras que los ricos se hacen más ricos. Los gobiernos se ven obligados a elegir entre pagar los intereses de la deuda o invertir en el futuro de sus ciudadanos. Esta elección, predeterminada por la irresponsabilidad fiscal, es una condena para las generaciones futuras.
...
El sistema está diseñado para transferir riqueza de los pobres a los ricos. La crisis de 2026 será simplemente el siguiente capítulo de esta historia de injusticia y desigualdad. Expertos de la talla de Steve Hanke [han advertido repetidamente en ArXiv](https://arxiv.org/abs/2304.03651) sobre los peligros de la expansión monetaria descontrolada.

La pregunta no es si podemos evitar la crisis, sino cómo mitigar sus efectos. Prepárense. La tormenta está llegando. Y será mucho peor de lo que nadie se atreve a admitir.
