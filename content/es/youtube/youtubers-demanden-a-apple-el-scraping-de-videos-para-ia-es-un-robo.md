...
El problema no es solo la extracción de datos, sino la falta de transparencia. Los creadores no tienen forma de saber si sus vídeos han sido utilizados para entrenar a Siri o al nuevo Apple Intelligence. Esta opacidad crea una asimetría de información inaceptable donde el creador asume todos los riesgos y la corporación se queda con la totalidad del valor generado. La legislación actual, incluyendo la [Recomendación del Registro de Derechos de Autor de 2024](https://www.copyright.gov/1201/2024/2024_Section_1201_Registers_Recommendation.pdf), se queda corta ante este tipo de explotación masiva de datos.
...
La legalidad del scraping en España es un terreno pantanoso. Aunque la AEPD indica que el scraping puede ser legal si no infringe derechos de autor, la realidad es que la enforcement de estas normas es casi inexistente. La [Ley Orgánica 3/2018](https://par.nsf.gov/servlets/purl/10668025) de Protección de Datos y Garantía de los Derechos Digitales ofrece algunas herramientas, pero carece de los dientes necesarios para morder a corporaciones como Apple o Google.
...
El informe sobre [Derechos de Autor e Inteligencia Artificial](https://www.copyright.gov/ai/Copyright-and-Artificial-Intelligence-Part-1-Digital-Replicas-Report.pdf) destaca los riesgos de las réplicas digitales. La tecnología permite crear versiones sintéticas de personas reales que pueden ser utilizadas para publicidad o contenido sin su consentimiento explícito. Esto abre la puerta a un nuevo tipo de explotación donde la propia imagen del creador se convierte en un activo que puede ser monetizado por terceros sin compensación alguna.
...
- [copyright.gov](https://www.copyright.gov/1201/2024/2024_Section_1201_Registers_Recommendation.pdf)
- [par.nsf.gov](https://par.nsf.gov/servlets/purl/10668025)
