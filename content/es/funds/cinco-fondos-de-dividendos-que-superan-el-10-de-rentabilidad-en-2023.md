...
1. **Fondo A**: Rentabilidad de 11,2%, volatilidad del 8%, índice de Sharpe de 1,4 y una tarifa de gestión del 1,5%.
2. **Fondo B**: Rentabilidad de 10,8%, volatilidad del 7%, índice de Sharpe de 1,3 con una tarifa de 1,2%.
3. **Fondo C**: Rentabilidad de 12,0%, volatilidad del 9%, índice de Sharpe de 1,5 y una tarifa del 1,8%.
4. **Fondo D**: Rentabilidad de 10,5%, volatilidad del 6%, índice de Sharpe de 1,1 con una tarifa de 1,3%.
5. **Fondo E**: Rentabilidad de 13,4%, volatilidad del 10%, índice de Sharpe de 1,6 y una tarifa del 2,0%.
...
<script type="application/ld+json">{</script>
  ...
  "mainEntity": [{
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Los fondos de dividendos se enfocan en generar ingresos a través de dividendos, mientras que los fondos de crecimiento buscan aumentar el capital a través de la apreciación del precio de las acciones."
      }
    },
    {
      "@type": "Question",
      "name": "¿Qué tarifas debo considerar al elegir un fondo de dividendos?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Las tarifas de gestión son las más críticas, ya que pueden afectar significativamente los rendimientos a largo plazo. Asegúrese de comprender todas las tarifas asociadas, incluidas las de suscripción y rescate."
      }
    },
    {
      "@type": "Question",
      "name": "¿Los dividendos son garantizados?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No, los dividendos no están garantizados y pueden ser recortados o eliminados por las empresas en tiempos de dificultades financieras."
      }
    },
    {
      "@type": "Question",
      "name": "¿Cómo puedo diversificar mis inversiones en fondos de dividendos?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "La diversificación se puede lograr invirtiendo en diferentes fondos que abarcan múltiples sectores y regiones, así como considerando fondos de inversión cotizados (ETFs) que replican índices de dividendos."
      }
    }
  ]
}</script>
